...
public class DaoDvs extends BaseDao<TabDvs, String> implements IDaoDvs{
	...
	public <X extends BaseEntity> List<X> findByExample(X entity)
		...
		TabDvs currentDvs = (TabDvs)entity;
		if(currentDvs.getCodDvs()!= null && !currentDvs.getCodDvs().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.codDvs) like '%"+currentDvs.getCodDvs()+"%'";
		}
		if(currentDvs.getLibDvs()!= null && !currentDvs.getLibDvs().equals("")){
			clauseWhere = clauseWhere + "AND upper(o.libDvs) like '%"+currentDvs.getLibDvs()+"%'";
		}
		try{
