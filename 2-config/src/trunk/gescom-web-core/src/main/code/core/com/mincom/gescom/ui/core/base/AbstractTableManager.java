	...
	public void updateDataModel(){
		 ...
		 dataModel = new ExtendedTableDataModel<T>(new DataProvider<T>(){
			...
			public Object getKey(T item) {
				return ((GesComBaseEntity) item).getSpecialId();
			}
...
//		}
		...
		remove(((GesComBaseEntity) p$entity).getSpecialId());
	}
	...
	public boolean contains(T p$entity){
		...
		boolean bol = contains(((GesComBaseEntity) p$entity).getSpecialId());
...
//		return v$index;	
		...
		return getIndexOfEntity(((GesComBaseEntity) p$entity).getSpecialId());
