...
public class AutSpeImpCtrl extends GesComCtrl<TabAutSpeImp, TabAutSpeImp>{
	...
	public List<Traitement> getListeTraitements() {
		...
		v$traitement1.setMethode("genererAutImp");
	...
	public String afficher(){
		...
		List<TabPro> liste = ImpSvcoDelegaute.getSvcoAutSpeImp().rechercherProduitParCodAut(defaultVue.getEntiteCourante().getCodAut());
