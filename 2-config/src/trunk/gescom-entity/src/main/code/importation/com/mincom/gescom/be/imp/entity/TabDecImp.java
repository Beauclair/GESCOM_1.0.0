...
@Entity
@Table(name="TAB_DEC_IMP")
public class TabDecImp extends GesComBaseEntity implements Serializable{
...
private static final long serialVersionUID = 1L;
	...
	public TabDecImp(InfoUser infoUser){
	...
	@Column(name = "TAUX_DVS")
	private BigDecimal tauxDvs;
	...
	public Date getDatesDec(){
		if(this.datDec == null || this.datDec.trim().isEmpty())
			return null;
		else
			try {
				return DateTools.getDateValue(datDec);
			} catch (ParseException e) {
				return null;
			}
	}
	
	public void setDatesDec(Date date){
		if(date == null)
			this.datDec = null;
		else
			this.datDec = DateTools.formatDate(date);
	}
	...
	public void setTauxDvs(BigDecimal tauxDvs) {
		this.tauxDvs = tauxDvs;
	}

	public BigDecimal getTauxDvs() {
		return tauxDvs;
	}
